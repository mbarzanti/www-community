...
# Syntax: .\Enable-RDPAccess.ps1 -ComputerName <ComputerOrIP>
# See: https://4sysops.com/archives/enable-remote-desktop-on-remote-computers-with-powershell/
#
# PowerShell ExecutionPolicy must be set to Bypass
# Run Get-ExecutionPolicy (probably is set to Restricted)
# Run Set-ExecutionPolicy Bypass
# Use this script and run Set-ExecutionPolicy Restricted
#
[cmdletbinding()]
param(
