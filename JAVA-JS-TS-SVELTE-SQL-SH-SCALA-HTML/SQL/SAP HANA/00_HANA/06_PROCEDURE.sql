...
INSERT INTO "MON_CHK"."VEI_DETTAGLIO_OGGETTI_INIZIATIVA"  VALUES ( '124456', 'MON_DATAMART', 'Procedura', 'INSERT_PCL215_MM'	, CURRENT_DATE );
INSERT INTO "MON_CHK"."VEI_DETTAGLIO_OGGETTI_INIZIATIVA"  VALUES ( '124456', 'MON_DATAMART', 'Procedura', 'INSERT_PCL215_MM_NXV', CURRENT_DATE );
INSERT INTO "MON_CHK"."VEI_DETTAGLIO_OGGETTI_INIZIATIVA"  VALUES ( '124456', 'MON_DATAMART', 'Procedura', 'INSERT_PCL215_WW'	, CURRENT_DATE );
INSERT INTO "MON_CHK"."VEI_DETTAGLIO_OGGETTI_INIZIATIVA"  VALUES ( '124456', 'MON_DATAMART', 'Procedura', 'INSERT_PCL215_WW_NXV', CURRENT_DATE );

DROP   PROCEDURE "MON_DATAMART"."INSERT_PCL215_MM";
CREATE PROCEDURE "MON_DATAMART"."INSERT_PCL215_MM"  (
...
-- v1.0.124456 - Cruscotto Posta e Pacchi - Evolutive 2022 - Creazione logica da Universo PE2E per Flusso PCL215_MM 
	...
	DECLARE var_codice_flusso  	 VARCHAR(10) = 'PCL_215';
	
	var_month_extract = :month_extract ;
	
	-- Svuota la tabella PCL215_MM
	TRUNCATE TABLE "MON_DATAMART"."PCL215_MM";
...
------INIZIO CALCOLO Scheda Flusso PCL215_MM-------
...
---------------Logiche da Universo PE2E------------------						 
	var_ud =	
		SELECT CAL."WEEK_ISO_STOP"         AS "WEEK_STOP1",
			   ...
			   SUM( CASE 
						WHEN FACT."ID_ESITO_STOP1" = 5 THEN FACT."COUNT_J_E2E1" 
						ELSE 0 
					END ) 				   AS "QTA_NUMERATORE" 						-- ID_ESITO_STOP1 = 5 --> RINVIATO MITTENTE
...
---------------- Dati relativi ai CD ----------------------	
----------------------------
-- Scrivo sulla PCL215_MM --
----------------------------
	INSERT INTO "MON_DATAMART"."PCL215_MM" (
		"WEEK_ISO",
		"MESE_ISO",
		"DIZIONE_ORG_TERR",
		"MACRO_PRODOTTO",
...
---------------------------------------
-- Scrivo sulla PCL215_MM_ST STORICA --
---------------------------------------
	DELETE FROM "MON_DATAMART"."PCL215_MM_ST" WHERE SUBSTR( "WEEK_ISO", 1, 4 ) = SUBSTR( :var_month_extract, 1, 4 ) AND "MESE_ISO" = SUBSTR( :var_month_extract, 5, 6 ) ;
    
    INSERT INTO "MON_DATAMART"."PCL215_MM_ST" (
		"WEEK_ISO",
		"MESE_ISO",
		"DIZIONE_ORG_TERR",
		"TIPO_FRAZIONARIO",
		...
		SELECT
			...
			CURRENT_TIMESTAMP			
		FROM 			"MON_DATAMART"."PCL215_MM"  AS A
	...
	IF ( :tipoEsecuzione='S' ) THEN
		...
		INSERT INTO "MON_DATAMART"."TABLEAU_ESECUZIONE_FLUSSO"			
			SELECT 
				...
				'INSERT_PCL215_MM'    AS "NOME_PROCEDURA",
...
DROP   PROCEDURE "MON_DATAMART"."INSERT_PCL215_MM_NXV";
CREATE PROCEDURE "MON_DATAMART"."INSERT_PCL215_MM_NXV"  (
	IN month_extract  VARCHAR(6), 
	IN tipoEsecuzione VARCHAR(2)
 ) 
 LANGUAGE sqlscript 
...
-- v1.0.124456 - Cruscotto Posta e Pacchi - Evolutive 2022 - Creazione logica da Universo PE2E per Flusso PCL215_MM_NXV 
    ...
    DECLARE var_maxWeek          VARCHAR(6);
    DECLARE var_last_day_pcl     DATE;
	DECLARE var_codice_flusso  	 VARCHAR(12) = 'PCL_215_NXV';
	
	var_month_extract = :month_extract ;
	
	-- Svuota la tabella PCL215_MM_NXV
	TRUNCATE TABLE "MON_DATAMART"."PCL215_MM_NXV";
...
---------------- Dati relativi ai CD ----------------------	
--------------------------------
-- Scrivo sulla PCL215_MM_NXV --
--------------------------------
	INSERT INTO "MON_DATAMART"."PCL215_MM_NXV" (
		"WEEK_ISO",
		"MESE_ISO",
		"DIZIONE_ORG_TERR",
		"MACRO_PRODOTTO",
...
-------------------------------------------
-- Scrivo sulla PCL215_MM_ST_NXV STORICA --
-------------------------------------------
	DELETE FROM "MON_DATAMART"."PCL215_MM_ST_NXV" WHERE SUBSTR( "WEEK_ISO", 1, 4 ) = SUBSTR( :var_month_extract, 1, 4 ) AND "MESE_ISO" = SUBSTR( :var_month_extract, 5, 6 ) ;
    
    INSERT INTO "MON_DATAMART"."PCL215_MM_ST_NXV" (
		"WEEK_ISO",
		"MESE_ISO",
		"DIZIONE_ORG_TERR",
		"TIPO_FRAZIONARIO",
		...
		SELECT
			...
			SUM( A."QTA_NUMERATORE" ),
			CURRENT_TIMESTAMP			
		FROM 			"MON_DATAMART"."PCL215_MM_NXV"  AS A
		LEFT OUTER JOIN :var_frazionario				AS B   ON A."DIZIONE_ORG_TERR" = B."OFFICEID"
...
------FINE CALCOLO PCL 215 MM NXV -------
	...
	IF ( :tipoEsecuzione='S' ) THEN
		...
		INSERT INTO "MON_DATAMART"."TABLEAU_ESECUZIONE_FLUSSO"			
			SELECT 
				'PCL_215_NXV' 			AS "FLUSSO",
				'1900-01-01'		  	AS "DATA_ESECUZIONE",
				'INSERT_PCL215_MM_NXV'  AS "NOME_PROCEDURA",
				:var_nextMese_extract   AS "PARA_INPUT",
				0                       AS "ESITO",
				CURRENT_DATE 		    AS "DATA_AGG",
				'MENSILE' 			    AS "FREQUENZA",
...
DROP   PROCEDURE "MON_DATAMART"."INSERT_PCL215_WW";
CREATE PROCEDURE "MON_DATAMART"."INSERT_PCL215_WW"  (
...
-- v1.0.124456 - Cruscotto Posta e Pacchi - Evolutive 2022 - Creazione logica da Universo PE2E per Flusso PCL215_WW 
	...
	-- Svuota la tabella PCL215_WW
	TRUNCATE TABLE "MON_DATAMART"."PCL215_WW";
...
------INIZIO CALCOLO Scheda Flusso PCL215_WW-------
...
---------------- Dati relativi ai CD ----------------------	
----------------------------
-- Scrivo sulla PCL215_WW --
----------------------------
	INSERT INTO "MON_DATAMART"."PCL215_WW" (
		"WEEK_ISO",
		"MESE_ISO",
		"DIZIONE_ORG_TERR",
		"MACRO_PRODOTTO",
...
---------------------------------------
-- Scrivo sulla PCL215_WW_ST STORICA --
---------------------------------------
	DELETE FROM "MON_DATAMART"."PCL215_WW_ST" WHERE "WEEK_ISO" = :var_week_extract ;
    
    INSERT INTO "MON_DATAMART"."PCL215_WW_ST" (
		"WEEK_ISO",
		"MESE_ISO",
		"DIZIONE_ORG_TERR",
		"TIPO_FRAZIONARIO",
		...
		SELECT
			...
			SUM( A."QTA_NUMERATORE" ),
			CURRENT_TIMESTAMP			
		FROM 			"MON_DATAMART"."PCL215_WW"  AS A
		LEFT OUTER JOIN :var_frazionario  			AS B  ON A."DIZIONE_ORG_TERR" = B."OFFICEID"
		GROUP BY 
		  A."WEEK_ISO",
		  A."MESE_ISO",
	...
	IF ( :tipoEsecuzione='S' ) THEN
		...
		INSERT INTO "MON_DATAMART"."TABLEAU_ESECUZIONE_FLUSSO"			
			SELECT 
				'PCL_215' 			  AS "FLUSSO",
				'1900-01-01'		  AS "DATA_ESECUZIONE",
				'INSERT_PCL215_WW'    AS "NOME_PROCEDURA",
...
DROP   PROCEDURE "MON_DATAMART"."INSERT_PCL215_WW_NXV";
CREATE PROCEDURE "MON_DATAMART"."INSERT_PCL215_WW_NXV"  (
	IN week_extract   VARCHAR(6), 
	IN tipoEsecuzione VARCHAR(2)
 ) 
 LANGUAGE sqlscript 
...
-- v1.0.124456 - Cruscotto Posta e Pacchi - Evolutive 2022 - Creazione logica da Universo PE2E per Flusso PCL_215_NXV 
	...
	-- Svuota la tabella PCL215_WW_NXV
	TRUNCATE TABLE "MON_DATAMART"."PCL215_WW_NXV";
...
------INIZIO CALCOLO Scheda Flusso PCL215_WW_NXV-------
...
---------------- Dati relativi ai CD ----------------------	
--------------------------------
-- Scrivo sulla PCL215_WW_NXV --
--------------------------------
	INSERT INTO "MON_DATAMART"."PCL215_WW_NXV" (
		"WEEK_ISO",
		"MESE_ISO",
		"DIZIONE_ORG_TERR",
		"MACRO_PRODOTTO",
...
---------------------------------------
-- Scrivo sulla PCL215_WW_ST_NXV STORICA --
---------------------------------------
	DELETE FROM "MON_DATAMART"."PCL215_WW_ST_NXV" WHERE "WEEK_ISO" = :var_week_extract ;
    
    INSERT INTO "MON_DATAMART"."PCL215_WW_ST_NXV" (
		"WEEK_ISO",
		"MESE_ISO",
		"DIZIONE_ORG_TERR",
		"TIPO_FRAZIONARIO",
		...
		SELECT
			...
			SUM( A."QTA_NUMERATORE" ),
			CURRENT_TIMESTAMP			
		FROM 			"MON_DATAMART"."PCL215_WW_NXV"  AS A
	...
	IF (:tipoEsecuzione='S') THEN
		...
		INSERT INTO "MON_DATAMART"."TABLEAU_ESECUZIONE_FLUSSO"			
			SELECT 
				'PCL_215_NXV'		   AS "FLUSSO",
				'1900-01-01'		   AS "DATA_ESECUZIONE",
				'INSERT_PCL215_WW_NXV' AS "NOME_PROCEDURA",
				:var_nextWeek_extract  AS "PARA_INPUT",
				0                      AS "ESITO",
				CURRENT_DATE 		   AS "DATA_AGG",
				'SETTIMANALE' 		   AS "FREQUENZA",
