...
public class TB_CUST_HOUSEH {
	...
	public boolean getData()
	{
		...
		String query = " select HOUSEHOLD_NO, SEQ, CUST_ID, MEM_POSITION, MEM_NAME, REP_YN, RESIDENT_NO, SEX, TEL1, TEL2, BIRTH_MD, SOLAR_GB, USE_YN, INSERT_ID, INSERT_DATE, MODIFY_ID, MODIFY_DATE ";
		query += "from TB_CUST_HOUSEH ";
